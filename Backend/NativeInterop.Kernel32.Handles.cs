...
partial class Interop
{
    public static unsafe partial class Kernel32
    {
        ...
        [DllImport(Libraries.Kernel32, CallingConvention = CallingConvention.Winapi, SetLastError = false)]
        ...
        [DllImport(Libraries.Kernel32, EntryPoint = "DuplicateHandle", SetLastError = true)]
