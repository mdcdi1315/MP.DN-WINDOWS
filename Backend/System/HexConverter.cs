...
namespace System
{
    internal static class HexConverter
    {
        ...
        private static unsafe void ToString_SpanAction(Span<System.Char> chars, (System.IntPtr RosPtr, Casing casing) args)
...
#pragma warning disable CS8500 // takes address of managed type
            return string.Create(bytes.Length * 2, (RosPtr: (IntPtr)(&bytes), casing), new(ToString_SpanAction));
