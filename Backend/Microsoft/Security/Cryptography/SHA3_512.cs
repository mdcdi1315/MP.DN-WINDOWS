...
namespace Microsoft.Security.Cryptography
{
    ...
    public abstract class SHA3_512 : HashAlgorithm
    {
        ...
        /// </value>
        public static bool IsSupported => true; // TODO: Check when support is present for Gen 3 SHA algs
        ...
        public static bool TryHashData(ReadOnlySpan<byte> source, Span<byte> destination, out int bytesWritten)
        {
            ...
            bytesWritten = BCryptHashProvider.HashDataAndReturnDirectly(HashAlgorithmNames.SHA3_512, source, destination);
        ...
        public static int HashData(Stream source, Span<byte> destination)
        {
            ...
            CheckSha3Support();
            return BCryptHashProvider.HashDataStreamAndReturnDirectly(HashAlgorithmNames.SHA3_512, source, destination);
        }
        ...
        public static byte[] HashData(Stream source)
        {
            ...
            BCryptHashProvider.HashDataStreamAndReturnDirectly(HashAlgorithmNames.SHA3_512, source, buffertemp);
        ...
        private sealed class Implementation : SHA3_512
        {
            ...
            {
                _hashProvider = new BCryptHashProvider(HashAlgorithmNames.SHA3_512);
