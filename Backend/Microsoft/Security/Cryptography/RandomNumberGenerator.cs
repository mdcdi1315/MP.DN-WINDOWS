...
#pragma warning disable 8500
        private static unsafe void GetString_SpanAction(System.Span<System.Char> chars , System.IntPtr state)
            => GetItemsCore(*(ReadOnlySpan<char>*)state, chars);
...
#pragma warning disable 8500
            return string.Create(length, (IntPtr)(&choices), new(GetString_SpanAction));
#pragma warning restore 8500
        }
        ...
        public static string GetHexString(int stringLength, bool lowercase = false)
        {
            ...
            return string.Create(stringLength, lowercase, new(GetHexStringCore));
        }
