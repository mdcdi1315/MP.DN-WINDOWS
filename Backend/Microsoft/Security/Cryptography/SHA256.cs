...
namespace Microsoft.Security.Cryptography
{
    public abstract class SHA256 : HashAlgorithm
    {
        ...
        public static SHA256 Create() => new Implementation();
        ...
        public static bool TryHashData(ReadOnlySpan<byte> source, Span<byte> destination, out int bytesWritten)
        {
            ...
            bytesWritten = BCryptHashProvider.HashDataAndReturnDirectly(HashAlgorithmNames.SHA256, source, destination);
        ...
        public static int HashData(Stream source, Span<byte> destination)
        {
            ...
            return BCryptHashProvider.HashDataStreamAndReturnDirectly(HashAlgorithmNames.SHA256, source, destination);
        }
        ...
        public static byte[] HashData(Stream source)
        {
            ...
            BCryptHashProvider.HashDataStreamAndReturnDirectly(HashAlgorithmNames.SHA256, source, buffertemp);
        ...
        private sealed class Implementation : SHA256
        {
            ...
            {
                _hashProvider = new BCryptHashProvider(HashAlgorithmNames.SHA256);
