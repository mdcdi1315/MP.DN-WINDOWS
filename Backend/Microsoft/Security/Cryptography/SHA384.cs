...
namespace Microsoft.Security.Cryptography
{
    public abstract class SHA384 : HashAlgorithm
    {
        ...
        public static SHA384 Create() => new Implementation();
        ...
        public static bool TryHashData(ReadOnlySpan<byte> source, Span<byte> destination, out int bytesWritten)
        {
            ...
            bytesWritten = BCryptHashProvider.HashDataAndReturnDirectly(HashAlgorithmNames.SHA384, source, destination);
        ...
        public static int HashData(Stream source, Span<byte> destination)
        {
            ...
            return BCryptHashProvider.HashDataStreamAndReturnDirectly(HashAlgorithmNames.SHA384, source, destination);
        }
        ...
        public static byte[] HashData(Stream source)
        {
            ...
            BCryptHashProvider.HashDataStreamAndReturnDirectly(HashAlgorithmNames.SHA384, source, buffertemp);
        ...
        private sealed class Implementation : SHA384
        {
            ...
            {
                _hashProvider = new BCryptHashProvider(HashAlgorithmNames.SHA384);
