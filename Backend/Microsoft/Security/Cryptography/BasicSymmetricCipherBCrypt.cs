...
namespace Microsoft.Security.Cryptography
{
    internal sealed class BasicSymmetricCipherBCrypt : BasicSymmetricCipher
    {
        ...
        public BasicSymmetricCipherBCrypt(SafeBCryptAlgorithmProviderHandle algorithm, CipherMode cipherMode, int blockSizeInBytes, int paddingSizeInBytes, ReadOnlySpan<byte> key, bool ownsParentHandle, byte[] iv, bool encrypting)
