...
namespace Microsoft.Security.Cryptography
{
    ...
    public readonly struct HashAlgorithmName : IEquatable<HashAlgorithmName>
    {
        ...
        public override bool Equals([NotNullWhen(true)] object obj) => obj is HashAlgorithmName name && Equals(name);
        ...
        public static HashAlgorithmName FromOid(string oidValue)
        {
            ...
            throw new CryptographicException(System.String.Format(SR.Cryptography_InvalidHashAlgorithmOid, oidValue));
        }
    }
}
