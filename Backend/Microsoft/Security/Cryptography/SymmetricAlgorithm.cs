...
namespace Microsoft.Security.Cryptography
{
    public abstract class SymmetricAlgorithm : IDisposable
    {
        ...
        {
            KeySizes[] validSizes = LegalKeySizes;
        ...
        public byte[] EncryptEcb(ReadOnlySpan<byte> plaintext, PaddingMode paddingMode)
        {
                ...
                written != ciphertextLength)
            {
                ...
                throw new CryptographicException(System.String.Format(SR.Cryptography_EncryptedIncorrectLength, nameof(TryEncryptEcbCore)));
            }
            ...
            PaddingMode paddingMode = PaddingMode.PKCS7)
        {
                ...
                written != ciphertextLength)
            {
                ...
                // place. It doesn't make sense to try and support partial block encryption, likely
                // something went very wrong. So throw.
                throw new CryptographicException(System.String.Format(SR.Cryptography_EncryptedIncorrectLength, nameof(TryEncryptCbcCore)));
            }
            ...
            int feedbackSizeInBits = 8)
        {
                ...
                written != ciphertextLength)
            {
                ...
                // place. It doesn't make sense to try and support partial block encryption, likely
                // something went very wrong. So throw.
                throw new CryptographicException(System.String.Format(SR.Cryptography_EncryptedIncorrectLength, nameof(TryEncryptCfbCore)));
            }
