...
namespace Microsoft.IO.Enumeration
{
    ...
    public abstract unsafe partial class FileSystemEnumerator<TResult> : CriticalFinalizerObject, IEnumerator<TResult>
    {
        ...
        private bool GetData()
        {
            ...
            switch (nts)
            {
                case Interop.NTSTATUS.STATUS_NO_MORE_FILES:
                    DirectoryFinished();
                    return false;
                ...
                case Interop.NTSTATUS.STATUS_FILE_NOT_FOUND:
                    DirectoryFinished();
                    return false;
                default:
                    int error = (int)Interop.NtDll.RtlNtStatusToDosError(nts);
        ...
        {
            (Interop.NTSTATUS status, IntPtr handle) = Interop.NtDll.CreateFile(
                relativePath,
                _directoryHandle,
