...
namespace Microsoft.IO.Enumeration
{
    internal static class FileSystemEnumerableFactory
    {
        ...
        private static System.String UserFilesDirectories_D(ref FileSystemEntry entry) => entry.ToSpecifiedFullPath();
            ...
            EnumerationOptions options)
        {
            return new FileSystemEnumerable<string>(
                directory,
                new(UserFilesDirectories_D),
                options)
            {
                ShouldIncludePredicate = (ref FileSystemEntry entry) => !entry.IsDirectory && MatchesPattern(expression, entry.FileName, options)
            };
        }
            ...
            EnumerationOptions options)
        {
            return new FileSystemEnumerable<string>(
                ...
                options)
            {
                ShouldIncludePredicate = new((ref FileSystemEntry entry) =>
        ...
        private static FileInfo FileInfos_D(ref FileSystemEntry entry) => entry.ToFileSystemInfo() as FileInfo;
        ...
        private static DirectoryInfo DirInfos_D(ref FileSystemEntry entry) => entry.ToFileSystemInfo() as DirectoryInfo;
        ...
        private static FileSystemInfo FileSysInfos_D(ref FileSystemEntry entry) => entry.ToFileSystemInfo();
            ...
            bool isNormalized)
        {
            return new FileSystemEnumerable<FileSystemInfo>(
               ...
               isNormalized)
            {
                ShouldIncludePredicate = (ref FileSystemEntry entry) => MatchesPattern(expression, entry.FileName, options)
            };
        }
    }
}
