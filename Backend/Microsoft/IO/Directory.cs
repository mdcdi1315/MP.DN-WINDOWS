    ...
    public static partial class Directory
    {
        ...
        public static void Move(string sourceDirName, string destDirName)
        {
            ...
            if (!FileSystem.DirectoryExists(fullsourceDirName) && !FileSystem.FileExists(fullsourceDirName))
                throw new DirectoryNotFoundException(System.String.Format(SR.IO_PathNotFound_Path, fullsourceDirName));
            
            if (FileSystem.DirectoryExists(fulldestDirName))
                throw new IOException(System.String.Format(SR.IO_AlreadyExists_Name, fulldestDirName));
