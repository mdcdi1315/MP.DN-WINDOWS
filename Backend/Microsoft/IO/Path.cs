...
namespace Microsoft.IO
{
    ...
    public static partial class Path
    {
        ...
        [Obsolete("Please use GetInvalidPathChars or GetInvalidFileNameChars instead." , false)]
        ...
        // 12 == 8 + 1 (for period) + 3
        private static unsafe void GetRandomFileName_SpanAction(System.Span<System.Char> span, System.IntPtr key)
        ...
        public static unsafe string GetRandomFileName()
        {
            ...
            return string.Create(12, (IntPtr)pKey, new(GetRandomFileName_SpanAction));
        }
        ...
        public static bool IsPathFullyQualified(ReadOnlySpan<char> path) => PathInternal.IsPartiallyQualified(path) == false;
        ...
        {
            if (path is not null) { return HasExtension(path.AsSpan()); }
            return false;
        }
        ...
        private static unsafe void JoinInternal_SpanAction2(System.Span<System.Char> destination , 
            (System.IntPtr First , System.Int32 FirstLength , System.IntPtr Second , System.Int32 SecondLength , System.Boolean HasSeparator) state)
        {
        ...
        private static unsafe string JoinInternal(ReadOnlySpan<char> first, ReadOnlySpan<char> second)
        {
            ...
            fixed (char* f = &MemoryMarshal.GetReference(first), s = &MemoryMarshal.GetReference(second))
            {
                return string.Create(
                    ...
                    new(JoinInternal_SpanAction2));
            }
        }

        private static unsafe void JoinInternal_SpanAction3(System.Span<System.Char> destination,
            (System.IntPtr First, System.Int32 FirstLength, System.IntPtr Second, System.Int32 SecondLength, System.IntPtr Third , System.Int32 ThirdLength , System.Boolean FirstHasSeparator , System.Boolean ThirdHasSeparator) state)
        {
            new Span<char>((char*)state.First, state.FirstLength).CopyTo(destination);
        ...
        private static unsafe string JoinInternal(ReadOnlySpan<char> first, ReadOnlySpan<char> second, ReadOnlySpan<char> third)
        {
            ...
            fixed (char* f = &MemoryMarshal.GetReference(first), s = &MemoryMarshal.GetReference(second), t = &MemoryMarshal.GetReference(third))
            {
                return string.Create(
                    ...
                    new(JoinInternal_SpanAction3));
            }
        }

        private static unsafe void JoinInternal_SpanAction4(System.Span<System.Char> destination,
            (System.IntPtr First, System.Int32 FirstLength, System.IntPtr Second, System.Int32 SecondLength, System.IntPtr Third, System.Int32 ThirdLength, System.IntPtr Fourth , System.Int32 FourthLength , System.Boolean FirstHasSeparator, System.Boolean ThirdHasSeparator , System.Boolean FourthHasSeparator) state)
        {
            new Span<char>((char*)state.First, state.FirstLength).CopyTo(destination);
            if (!state.FirstHasSeparator)
                destination[state.FirstLength] = PathInternal.DirectorySeparatorChar;
        ...
        private static string GetRelativePath(string relativeTo, string path, StringComparison comparisonType)
        {
            ...
            if (PathInternal.IsEffectivelyEmpty(relativeTo.AsSpan()))
                throw new ArgumentException(SR.Argument_EmptyPath, nameof(relativeTo));
