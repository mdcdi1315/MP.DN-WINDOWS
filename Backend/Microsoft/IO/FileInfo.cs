    ...
    public sealed partial class FileInfo : FileSystemInfo
    {
        ...
        public long Length
        {
            get
            {
                ...
                {
                    throw new FileNotFoundException(System.String.Format(SR.IO_FileNotFound_FileName, FullPath), FullPath);
                }
                return LengthCore;
            }
        }
        ...
        public void MoveTo(string destFileName, bool overwrite)
        {
            ...
            if (!new DirectoryInfo(Path.GetDirectoryName(FullName)).Exists)
                throw new DirectoryNotFoundException(System.String.Format(SR.IO_PathNotFound_Path, FullName));

            if (!Exists)
                throw new FileNotFoundException(System.String.Format(SR.IO_FileNotFound_FileName, FullName), FullName);
