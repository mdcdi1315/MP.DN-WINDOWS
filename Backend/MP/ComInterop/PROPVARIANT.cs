            ...
            get {
                switch (Type)
                {
                    ...
                    case VARTYPE.VT_UNKNOWN:
                        return Marshal.GetObjectForIUnknown(PPVTValue.pointerValue);
            ...
            set {
                ...
                switch (value)
                {
                    ...
                    case System.String s:
                        System.UInt32 flen = ((s.Length + 1) * sizeof(System.Char)).ToUInt32();
                        void* ptr = Interop.Ole32.CoTaskMemAlloc(flen.ToUInt64());
                        if (ptr is null) {
                    ...
                    case CURRENCY cy:
                        ...
                        break;
                    case GUID guid:
                        GUID* pguid = (GUID*)Interop.Ole32.CoTaskMemAlloc(sizeof(GUID).ToUInt64());
                        if (pguid is null) {
                    ...
                    case System.Byte[] bt:
                        BLOB blb = new();
                        blb.Length = bt.LongLength.ToUInt32();
                        blb.Data = (System.Byte*)Interop.Ole32.CoTaskMemAlloc(blb.Length.ToUInt64());
                        if (blb.Data is null) {
                    ...
                    case System.DateTime dt:
                        ...
                        PPVTValue.filetime = Interop.FILETIME.FromDateTime(dt);
                        break;
                }
