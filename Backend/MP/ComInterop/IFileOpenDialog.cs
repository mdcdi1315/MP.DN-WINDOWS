...
{
    [ComImport]
    [Guid(CommonInteropClsIds.IID_IFileOpenDialog)]
    [InterfaceType(ComInterfaceType.InterfaceIsIUnknown)]
    public unsafe interface IFileOpenDialog : IFileDialog
    {
        [PreserveSig]
        ...
        [PreserveSig]
        public HRESULT GetResults(/*IShellItemArray **ppenum*/ System.IntPtr* ishellitemarrayptr);
