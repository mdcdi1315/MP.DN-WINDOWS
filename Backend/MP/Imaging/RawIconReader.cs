...
namespace MP.Imaging
{
    ...
    public sealed class RawIconReader : IDisposable
    {
        ...
        public RawIconReader(System.IO.Stream stream)
        {
            basestream = stream;
            ...
            basestreamoffset = basestream.Position;
        ...
        public System.IO.Stream GetBitmapStream(System.Int32 ordinal)
        {
            ...
            basestream.Seek(basestreamoffset + entry.ImageOffset, System.IO.SeekOrigin.Begin);
            var retstream = new Microsoft.IO.MemoryStream(entry.ImageSize.ToInt32());
            basestream.CopyToExactly(retstream, 4096, entry.ImageSize);
