...
namespace MP.AudioLibrary.MediaFoundation
{
    ...
    [Guid(MediaFoundationInterfaceIds.IID_IMFAsyncCallback)]
    public unsafe interface IMFAsyncCallback
    {
        /// <summary>
        ...
        /// </remarks>
        [PreserveSig]
        HRESULT GetParameters(System.UInt32* pdwFlags, System.UInt32* pdwQueue);
        ...
        /// </param>
        [PreserveSig]
        HRESULT Invoke([IsPointerToCOMInterfaceType(typeof(IMFAsyncResult))] void* pAsyncResult);
    }
}