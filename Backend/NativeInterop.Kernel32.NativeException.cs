...
partial class Interop
{
    public static unsafe partial class Kernel32
    {
        ...
        [DllImport(Libraries.Kernel32, EntryPoint = "SetThreadErrorMode", SetLastError = true, ExactSpelling = true)]
        ...
        /// </summary>
        public static string GetMessage(System.Int32 errorCode) => GetMessage(errorCode, IntPtr.Zero);

        public static string GetMessage(System.Int32 errorCode, IntPtr moduleHandle)
        {
            ...
            if (GetLastError() == Errors.ERROR_INSUFFICIENT_BUFFER)
            {
                ...
                try
                {
                    int length = FormatMessage(flags | MessageFormatFlags.FORMAT_MESSAGE_ALLOCATE_BUFFER,
