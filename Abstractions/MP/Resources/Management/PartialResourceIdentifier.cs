...
namespace MP.Resources.Management
{
    ...
    /// </summary>
    public sealed class PartialResourceIdentifier : 
        IEquatable<PartialResourceIdentifier>,
        ...
        ICloneable
    {
        ...
        private static PartialResourceIdentifier BuildIdentifier([AllowNull] PartialResourceIdentifier base_id, String[] components)
        {
        ...
        public String Extension
        {
            get {
                String s = Name;
                int idx = s.IndexOf('.');
                return (idx > -1) ? s.Substring(idx+1) : System.String.Empty;
            }
        }
        ...
        public bool Equals([AllowNull] PartialResourceIdentifier other)
        {
        ...
        public override bool Equals(object obj) => obj is PartialResourceIdentifier other && Equals(other);
