...
namespace MP.Graphics
{
        ...
        ICloneable
    {
        ...
        /// <summary>
        /// If this <see cref="PointF"/> instance participates in a rectangle or window painting area, it re-maps this point to a larger or smaller rectangle, depending on the input parameters.
        /// </summary>
        ...
        /// <returns>The mapped <see cref="PointF"/> instance.</returns>
        public readonly PointF Map(SizeF old_bounds, SizeF new_bounds) => new(X * (new_bounds.Width / old_bounds.Width) , Y * (new_bounds.Height / old_bounds.Height));

        /// <summary>
        /// If this <see cref="PointF"/> instance participates in a rectangle or window painting area, it re-maps this point to a larger or smaller rectangle, depending on the input parameters. <br />
        /// Note that this overload properly devirtualizes point positions as realized by the rectangles provided, and as such, this is far more suitable to be used for typical applications than the <see cref="Map(SizeF, SizeF)"/> overload.
        /// </summary>
        ...
        /// <returns>The mapped <see cref="PointF"/> instance.</returns>
        public readonly PointF Map(RectangleF old_rect, RectangleF new_rect)
        {
            ...
            PointF mapped = (this - old_rect.TopLeft).Map(old_rect.Size , new_rect.Size);
        ...
        public readonly override int GetHashCode() => (System.Int32)unchecked(X + Y);
