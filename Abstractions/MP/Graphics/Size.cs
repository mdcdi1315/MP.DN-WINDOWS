...
namespace MP.Graphics
{
        ...
        IEqualityOperators<Size, Size, System.Boolean>
    {
        ...
        public readonly override int GetHashCode() => unchecked(Width + Height);

        /// <summary>Computes the absolute distance of the specified <see cref="Size"/>.</summary>
        /// <param name="self">The <see cref="Size"/> structure to compute it's distance.</param>
        /// <returns>The absolute distance (displacement) of <paramref name="self"/> from point (0, 0).</returns>
        public static int GetDistance(Size self) => unchecked(self.Width * self.Height);
        ...
        /// <summary>
        /// Performs the division of two <see cref="Size"/> structures. <br />
        ...
        /// </summary>
        /// <param name="left">The dividend <see cref="Size"/> structure.</param>
        /// <param name="right">The divisor <see cref="Size"/> structure.</param>
        /// <returns>The division result of dividing <paramref name="left"/> by <paramref name="right"/>.</returns>
        public static Size operator /(Size left, Size right) => new(left.Width / right.Width, left.Height / right.Height);

        /// <summary>
        /// Performs the multiplication of two <see cref="Size"/> structures. <br />
        /// Both components of <paramref name="left"/> are mapped to the respective components of <paramref name="right"/>. <br />
        /// Multiplication is performed as follows: <c>left.Width * right.Width, left.Height * right.Height</c>
        /// </summary>
        /// <param name="left">The first <see cref="Size"/> structure to multiply.</param>
        /// <param name="right">The second <see cref="Size"/> structure to multiply.</param>
