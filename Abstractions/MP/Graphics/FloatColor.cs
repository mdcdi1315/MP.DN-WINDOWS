...
namespace MP.Graphics
{
        ...
        ICloneable
    {
        ...
        /// <summary>Truncates this <see cref="FloatColor"/> instance to a <see cref="ARGBColor"/> instance.</summary>
        ...
        /// <summary>Truncates this <see cref="FloatColor"/> instance to a <see cref="RGBAColor"/> instance.</summary>
        /// <returns>The truncated result to RGB color intensities.</returns>
        readonly RGBAColor ITruncatable<RGBAColor>.Truncate() => new((byte)(red * 255f), (byte)(green * 255f), (byte)(blue * 255f) , (byte)(alpha * 255f));

        /// <summary>Truncates this <see cref="FloatColor"/> instance to a <see cref="BGRAColor"/> instance.</summary>
        /// <returns>The truncated result to RGB color intensities.</returns>
        readonly BGRAColor ITruncatable<BGRAColor>.Truncate() => new((byte)(blue * 255f), (byte)(green * 255f), (byte)(red * 255f), (byte)(alpha * 255f));
        ...
        public readonly override String ToString() => $"Color<RGBA, Float> {{ Red: {red} , Green: {green} , Blue: {blue} , Alpha: {alpha} }}";
