...
namespace MP.Graphics.OpenGL
{
    ...
    */
    ...
    /// </summary>
    [SuppressMessage("Usage", "CA2211:Non-constant fields should not be visible", Justification = "OpenGL Layer API")]
    public static unsafe class GL
    {
        ...
        public static void LoadFunctions(IOpenGLFunctionLoader loader)
        {
            ...
            try {
                ...
                {
                    dgf.SetValue(null, new IntPtr(loader.GetFunction(fn = dgf.Name)));
                }
            } catch (Exception) {
                DebugProvider.WriteLine($"OPENGLFUNCLOADER: Preparing LOADEXCEPTION report. Function {fn} failed to be loaded.");
                throw;
            }
            ...
            {
                dgf.SetValue(null, new IntPtr(loader.GetFunction(dgf.Name)));
            }
#endif
        }
        ...
        {
            foreach (var f in typeof(GL).GetFields(BindingFlags.Public | BindingFlags.Static)) { f.SetValue(null, new IntPtr(0L)); }
        }
        ...
        public static delegate* unmanaged[Cdecl]<ProgramObject, void> glValidateProgram;
        ...
        public static delegate* unmanaged[Cdecl]<ProgramObject, int, int*, byte*, void> glGetProgramInfoLog;
        ...
        public static delegate* unmanaged[Cdecl]<ProgramObject, int, int*, ShaderObject*, void> glGetAttachedShaders;
        ...
        public static delegate* unmanaged[Cdecl]<ShaderObject , void> glCompileShader;
        ...
        public static delegate* unmanaged[Cdecl]<ProgramObject, ProgramParameter, int*, void> glGetProgramiv;
        ...
        public static delegate* unmanaged[Cdecl]<ShaderObject , ShaderParameter , int*, void> glGetShaderiv;
        ...
        public static delegate* unmanaged[Cdecl]<uint, uint, void> glVertexAttribI1ui;
        ...
        public static delegate* unmanaged[Cdecl]<uint, float, float, void> glVertexAttrib2f;
        ...
        public static delegate* unmanaged[Cdecl]<uint, short, short, void> glVertexAttrib2s;
        ...
        public static delegate* unmanaged[Cdecl]<uint, double, double, void> glVertexAttrib2d;
        ...
        public static delegate* unmanaged[Cdecl]<uint, int, int, void> glVertexAttribI2i;
        ...
        public static delegate* unmanaged[Cdecl]<uint, uint, uint, void> glVertexAttribI2ui;
        ...
        public static delegate* unmanaged[Cdecl]<uint, float, float, float, void> glVertexAttrib3f;
        ...
        public static delegate* unmanaged[Cdecl]<uint, short, short, short, void> glVertexAttrib3s;
        ...
        public static delegate* unmanaged[Cdecl]<uint, double, double, double, void> glVertexAttrib3d;
        ...
        public static delegate* unmanaged[Cdecl]<uint, int, int, int, void> glVertexAttribI3i;
        ...
        public static delegate* unmanaged[Cdecl]<uint, uint, uint, uint, void> glVertexAttribI3ui;
        ...
        public static delegate* unmanaged[Cdecl]<uint, short, short, short, short, void> glVertexAttrib4s;
        ...
        public static delegate* unmanaged[Cdecl]<uint, double, double, double, double, void> glVertexAttrib4d;
        ...
        public static delegate* unmanaged[Cdecl]<uint, byte, byte, byte, byte, void> glVertexAttrib4Nub;
        ...
        public static delegate* unmanaged[Cdecl]<uint, int, int, int, int, void> glVertexAttribI4i;
        ...
        public static delegate* unmanaged[Cdecl]<uint, uint, uint, uint, uint, void> glVertexAttribI4ui;
        ...
        public static delegate* unmanaged[Cdecl]<uint, int, VertexAttributePointerDataType, byte, int, void*, void> glVertexAttribPointer;
        ...
        public static delegate* unmanaged[Cdecl]<uint, int, VertexAttributePointerDataType, int, void*, void> glVertexAttribIPointer;
        ...
        public static delegate* unmanaged[Cdecl]<int, float, float, void> glUniform2f;
        ...
        public static delegate* unmanaged[Cdecl]<int, float, float, float, void> glUniform3f;
        ...
        public static delegate* unmanaged[Cdecl]<int, float, float, float, float, void> glUniform4f;
        ...
        public static delegate* unmanaged[Cdecl]<int, int, int, void> glUniform2i;
        ...
        public static delegate* unmanaged[Cdecl]<int, int, int, int, void> glUniform3i;
        ...
        public static delegate* unmanaged[Cdecl]<int, int, int, int, int, void> glUniform4i;

        /// <summary>Gets the <c>glUniform1ui</c> delegate.</summary>
        /// <remarks><c>void glUniform1ui(GLint location, GLuint v0)</c></remarks>
        public static delegate* unmanaged[Cdecl]<int, uint, void> glUniform1ui;
        ...
        public static delegate* unmanaged[Cdecl]<int, uint, uint, void> glUniform2ui;
        ...
        public static delegate* unmanaged[Cdecl]<int, uint, uint, uint, void> glUniform3ui;
        ...
        public static delegate* unmanaged[Cdecl]<int, uint, uint, uint, uint, void> glUniform4ui;
        ...
        public static delegate* unmanaged[Cdecl]<int, int, uint*, void> glUniform1uiv;
        ...
        public static delegate* unmanaged[Cdecl]<int, int, uint*, void> glUniform2uiv;
        ...
        public static delegate* unmanaged[Cdecl]<int, int, uint*, void> glUniform3uiv;
        ...
        public static delegate* unmanaged[Cdecl]<int, int, uint*, void> glUniform4uiv;
        ...
        public static delegate* unmanaged[Cdecl]<int, int, byte, float*, void> glUniformMatrix2fv;
        ...
        public static delegate* unmanaged[Cdecl]<int, int, byte, float*, void> glUniformMatrix4fv;
        ...
        public static delegate* unmanaged[Cdecl]<int, int, byte, float*, void> glUniformMatrix2x3fv;
        ...
        public static delegate* unmanaged[Cdecl]<int, int, byte, float*, void> glUniformMatrix3x2fv;
        ...
        public static delegate* unmanaged[Cdecl]<int, int, byte, float*, void> glUniformMatrix2x4fv;
        ...
        public static delegate* unmanaged[Cdecl]<int, int, byte, float*, void> glUniformMatrix4x2fv;
        ...
        public static delegate* unmanaged[Cdecl]<int, int, byte, float*, void> glUniformMatrix3x4fv;
        ...
        public static delegate* unmanaged[Cdecl]<int, int, byte, float*, void> glUniformMatrix4x3fv;
        ...
        public static delegate* unmanaged[Cdecl]<ProgramObject, byte*, int> glGetUniformLocation;
        ...
        public static delegate* unmanaged[Cdecl]<ProgramObject, int, float*, void> glGetUniformfv;
        ...
        public static delegate* unmanaged[Cdecl]<ProgramObject, int, int*, void> glGetUniformiv;
        ...
        public static delegate* unmanaged[Cdecl]<ProgramObject, int, uint*, void> glGetUniformuiv;
        ...
        public static delegate* unmanaged[Cdecl]<DrawArraysPrimitiveType, int, int, void> glDrawArrays;
        ...
        public static delegate* unmanaged[Cdecl]<DrawArraysPrimitiveType, int, int, int, void> glDrawArraysInstanced;
        ...
        public static delegate* unmanaged[Cdecl]<DrawArraysPrimitiveType, int, DrawElementsDataType, void*, void> glDrawElements;
        ...
        public static delegate* unmanaged[Cdecl]<DrawArraysPrimitiveType, int, DrawElementsDataType, void*, int, void> glDrawElementsInstanced;
        ...
        public static delegate* unmanaged[Cdecl]<DrawArraysPrimitiveType, int, DrawElementsDataType, void*, int, void> glDrawElementsBaseVertex;
        ...
        public static delegate* unmanaged[Cdecl]<DrawArraysPrimitiveType, int, DrawElementsDataType, void*, int, int, void> glDrawElementsInstancedBaseVertex;
        ...
        public static delegate* unmanaged[Cdecl]<DrawArraysPrimitiveType, int, int, int, DrawElementsDataType, void*, void> glDrawRangeElements;
        ...
        public static delegate* unmanaged[Cdecl]<DrawArraysPrimitiveType, int, int, int, DrawElementsDataType, void*, int, void> glDrawRangeElementsBaseVertex;
        ...
        public static delegate* unmanaged[Cdecl]<float, byte, void> glSampleCoverage;
        ...
        public static delegate* unmanaged[Cdecl]<uint, void> glPrimitiveRestartIndex;
        ...
        public static delegate* unmanaged[Cdecl]<int, VertexArrayObject*, void> glGenVertexArrays;
        ...
        public static delegate* unmanaged[Cdecl]<int, VertexArrayObject*, void> glDeleteVertexArrays;

        /// <summary>Gets the <c>glBindVertexArray</c> delegate.</summary>
        /// <remarks><c>void glBindVertexArray(GLuint array)</c></remarks>
        public static delegate* unmanaged[Cdecl]<VertexArrayObject, void> glBindVertexArray;
