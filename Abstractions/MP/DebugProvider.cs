...
namespace MP
{
    ...
    {
        private static List<DebugSink> sinks;
        private static System.Boolean supported;
        private static List<DebugSource> sources;

        static DebugProvider()
        {
            sinks = new List<DebugSink>();
            sources = new List<DebugSource>();
#if DEBUG
            supported = true;
#else
            supported = false;
