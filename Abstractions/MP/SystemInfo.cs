...
namespace MP
{
    ...
    public static class SystemInfo
    {
        ...
        /// <exception cref="ArgumentNullException"><paramref name="layer"/> was <see langword="null"/>.</exception>
        ...
        public static void RegisterPlatformLayer(AbstractPlatformLayer layer)
        {
            ...
            AppDomain.CurrentDomain.DomainUnload += new(UnloadPlatformLayer);
        }
        ...
        /// <summary>
        /// Gets the default native memory manager instance, that is able to construct native memory handles and memory blocks directly.
        /// </summary>
        /// <returns>An <see cref="INativeMemoryManager"/> instance able to construct native memory handles.</returns>
        public static INativeMemoryManager GetDefaultMemoryManager() => apl.GetDefaultMemoryManager();
        ...
        public static IMemoryHandle CreateNativeMemory(System.UInt64 size) => GetDefaultMemoryManager().AllocateMemoryHandle(size);
        ...
        /// <exception cref="InsufficientMemoryException">Not enough memory to create the memory handle.</exception>
        [Throws(typeof(InsufficientMemoryException))]
        public static IMemoryHandle CreateNativeMemory(System.Int32 size) => GetDefaultMemoryManager().AllocateMemoryHandle(size.ToUInt64());
    }
}