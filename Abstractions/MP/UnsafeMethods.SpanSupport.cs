...
namespace MP
{
    unsafe partial class UnsafeMethods
    {
        ...
        private static T GetFromBytesTemplate2<T>(Span<System.Byte> span, System.Int32 sidx) where T : unmanaged
        {
        ...
        public static Span<System.Char> CastToChars(this Span<System.Byte> span, System.Int32 startindex)
        {
            Span<System.Char> ret = new System.Char[span.Length - startindex];
        ...
        /// <summary>
        /// Reads a structure of type <typeparamref name="T"/> from the specified byte span array.
        /// </summary>
        /// <typeparam name="T">The structure type to read.</typeparam>
        /// <param name="span">The byte span array to read the structure from.</param>
        ...
        public static T ReadStructure<T>(this Span<System.Byte> span , System.Int32 startindex)
            where T : struct
        {
            ...
            if (span.Length - startindex < ssize) { throw new ArgumentOutOfRangeException(nameof(startindex), $"The array is not large enough in order to read a structure of type {typeof(T).FullName}."); }
            Unsafe.CopyBlockUnaligned(ref Unsafe.As<T, System.Byte>(ref ret), ref span[startindex], ssize.ToUInt32());
            return ret;
        }
        ...
        public static void WriteStructure<T>(this Span<System.Byte> data, System.Int32 startindex, T structure) where T : struct
        {
            System.Int32 ssize = sizeof(T);
            if (startindex < 0) { throw new ArgumentOutOfRangeException(nameof(startindex)); }
