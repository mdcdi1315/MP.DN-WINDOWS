...
namespace MP.IO
{
    ...
    /// </summary>
    public class MemoryStream : DataStream
    {
        ...
        public MemoryStream()
        {
            ...
            expandable = true;
            position = length = 0L;
            buffer = Array.Empty<System.Byte>();
        }
        ...
        public MemoryStream(System.Int64 requiredcap, System.Boolean isexpandable)
        {
            if (requiredcap < 0) {
                ...
                buffer = new System.Byte[capacity];
            }
        }
        ...
        /// <inheritdoc />
        public override DataStreamMode Mode => DataStreamMode.ReadWrite | DataStreamMode.Seek;
        ...
        public override System.Int64 Position => position;
        ...
        /// <exception cref="ArgumentException"><paramref name="origin"/> was not a valid member of the <see cref="SeekDisplacement"/> enumeration.</exception>
        /// <exception cref="IOException">Computed stream position was overflown.</exception>
        public override System.Int64 Seek(System.Int64 offset, SeekDisplacement origin)
        {
            if (offset > MEMSTREAM_MAXLEN) {
                ...
                System.Int64 displacement = origin switch {
                    SeekDisplacement.Begin => offset,
                    SeekDisplacement.Current => position + offset,
                    SeekDisplacement.End => length - offset,
        ...
        public override void Write(ReadOnlySpan<System.Byte> buffer)
        {
            ...
            // and the underlying array bounds cannot afford the current capacity?
            System.Int64 fc = capacity, bound = position + buffer.Length;
        ...
        public override System.Int16 ReadByte() => (position < length) ? buffer[position++] : (short)(-1);
