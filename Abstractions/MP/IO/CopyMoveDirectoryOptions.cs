...
namespace MP.IO
{
    ...
    public enum CopyMoveDirectoryOptions : System.Byte
    {
        ...
        None,
        /// <summary>
        /// By default, <see cref="Directory.CopyTo(Directory, CopyMoveDirectoryOptions)"/> also copies the attributes of the source directory and it's files, making both directories 1-1 equal. <br />
        ...
        /// <summary>
        /// By default, <see cref="Directory.CopyTo(Directory, CopyMoveDirectoryOptions)"/> only copies the files existing in the directory object itself. <br/>
        /// When this flag is specified, all the files and the child directories and their files are copied too.
        /// </summary>
        RecursiveCopy = 1 << 1,
        /// <summary>
        /// By default, <see cref="Directory.CopyTo(Directory, CopyMoveDirectoryOptions)"/> uses the native OS routine to do the copy of the directories. <br />
