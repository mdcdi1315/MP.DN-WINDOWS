...
namespace MP.AudioLibrary
{
    ...
    public sealed class MonoToStereoAudioProvider : IAudioProvider
    {
        ...
        public System.Int32 Read(Span<System.Byte> buffer) 
        {
            ...
            System.Int32 rb = (buffer.Length / finalsamplesize) * monosamplesize;
            this.buffer.UpdateBufferSize(rb);
            System.Int32 rc = original.Read(new Span<System.Byte>(this.buffer.Buffer, 0, rb));
            if (rc == 0) { return 0; }
            ...
            for (System.Int32 I = 0 , J = 0; I < stereosize; I += finalsamplesize , J += monosamplesize)
            {
