...
namespace MP.AudioLibrary
{
    ...
    public class AudioFormat
    {
        ...
        /// <summary>
        /// Returns a string describing the current audio format.
        /// </summary>
        public override string ToString() => $"Audio Format: [ Sample Rate: {sr} Hz, Bit Rate: {br} bit, Channels: {layout.Length}, Common Format: {caf} ]";
    }
}