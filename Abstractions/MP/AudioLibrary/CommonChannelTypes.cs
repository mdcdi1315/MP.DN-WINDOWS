...
namespace MP.AudioLibrary
{
    ...
    public static class CommonChannelTypes
    {
        ...
        /// <summary>
        /// Gets the stereophonic channel layout, which in a single sample the left speaker data are first.
        /// </summary>
        ...
        /// However, note that you shouldn't use this as a general rule of thumb since channels can go at any position and thus you should create this by hand.
        /// </summary>
        ...
        public static ChannelType[] CreateLayoutFromNumberOfChannels(System.Int32 nch)
        {
            if (nch < 1) { throw new System.ArgumentOutOfRangeException(nameof(nch), "At least one channel must be specified."); }
            ChannelType ch, chlast = (ChannelType)nch;
            ChannelType[] channels = new ChannelType[nch];
            for (ch = 0; ch < chlast; ch++)
            {
                channels[(System.Int32)ch] = ch;
            }
            return channels;
        }
        ...
        public static System.Boolean IsEqualTo(this ChannelType[] layout1 , ChannelType[] layout2)
        {
            if (layout2 is null) { return false; }
            if (layout1.LongLength != layout2.LongLength) { return false; }

            System.Boolean equal = true;
            for (System.Int32 I = 0; I < layout1.Length; I++)
            {
        ...
        public static System.Int32 GetDataOffset(this ChannelType[] layout , ChannelType channel)
        {
