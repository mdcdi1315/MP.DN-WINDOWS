...
namespace MP.CGISettings
{
    ...
    /// </summary>
    public sealed class CGISettingsReader : ICGISettingsReader<SettingEntry> , IStreamOwnerBase
    {
        internal List<ICGISettingExtension> exts;
        internal System.Text.Encoding stringenc;
        internal System.IO.Stream stream;
        private System.Boolean strmown;
        private System.String appname;
        internal System.Int64 offset;
        internal CGIHEADER header;
        ...
        public CGISettingsReader(System.IO.Stream stream)
        {
            if (stream is null) {
        ...
        {
            System.Byte[] retrieved = new System.Byte[Unsafe.SizeOf<CGIHEADER>()];
            if (stream.Read(retrieved, 0, retrieved.Length) < retrieved.Length)
            {
                throw new System.IO.EndOfStreamException("The stream ended unexpectedly.");
            }
            header = retrieved.ReadStructure<CGIHEADER>(0);
            ...
            stream.Seek(header.Padding, System.IO.SeekOrigin.Current);
            retrieved = new System.Byte[header.AppNameLength];
            if (stream.Read(retrieved, 0, retrieved.Length) < retrieved.Length)
            {
                throw new System.IO.EndOfStreamException("The stream ended unexpectedly.");
            }
            appname = System.Text.Encoding.UTF8.GetString(retrieved);
            retrieved = null;
        ...
        public CGISettingsEnumerator GetEnumerator() => new(this);
