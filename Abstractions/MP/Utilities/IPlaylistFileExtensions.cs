...
{
    /// <summary>
    /// Defines generic purpose extension methods around the <see cref="IPlaylistFile"/> interface.
    /// </summary>
    public static class IPlaylistFileExtensions
    {
        /// <summary>
        /// Uses the <see cref="IPlaylistFile.Name"/> property to strip out only the file's name, tossing out it's extension part.
        /// </summary>
        /// <param name="info">The playlist file to get it's stripped name.</param>
        /// <returns>The stripped name of the file. If the file does not have an extension , it returns the <see cref="IPlaylistFile.Name"/> property as-is.</returns>
        public static System.String GetNameOnly(this IPlaylistFile info)
        {
        ...
        public static System.String GetFileSizeAsFriendlyString(this IPlaylistFile file)
        {
