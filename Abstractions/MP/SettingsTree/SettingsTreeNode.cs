...
namespace MP.SettingsTree
{
    ...
    public sealed class SettingsTreeNode
    {
        ...
        /// <summary>
        /// Adds a new setting to this node.
        /// </summary>
        /// <param name="setting">The setting object to add.</param>
        /// <exception cref="ArgumentNullException"><paramref name="setting"/> was <see langword="null"/>.</exception>
        public void AddNewSetting(SettingsTreeSetting setting)
        {
            ArgumentNullException.ThrowIfNull(setting);
            (settings ??= new(2)).Add(setting);
        }

        /// <summary>
        /// Adds a new setting to this node.
        /// </summary>
        /// <param name="type">The type of the new setting element.</param>
        /// <param name="id">The id of the new setting element.</param>
        /// <param name="typeofsetting">The setting element backing type.</param>
        /// <param name="desc">The human description of the setting.</param>
        /// <param name="descisres">A value whether the <paramref name="desc"/> is a resource string.</param>
        /// <param name="friendlyname">A friendly name for the current setting.</param>
        /// <param name="imageid">Optional. A resource ID for retrieveing an image.</param>
        /// <param name="range">Optional. If this setting denotes a numeric range, it should be defined here.</param>
        ...
        /// <summary>
        /// Removes a setting entry defined in the current node with the specified <paramref name="id"/>.
        /// </summary>
        /// <param name="id">The ID of the setting entry which is to be removed.</param>
        /// <returns><see langword="true"/> when the entry was found and successfully removed; otherwise, <see langword="false"/>.</returns>
        /// <exception cref="ArgumentNullException"><paramref name="id"/> was null or the empty string.</exception>
        ...
        /// <summary>
        /// Gets all the settings contained in this and the child nodes of this node.
        /// </summary>
        /// <returns>A collection of all the currently-defined settings for this node.</returns>
        public IEnumerable<SettingsTreeSetting> EnumerateSettings() => BuilderHelpers.EnumerateSettings(this);
