...
namespace MP
{
    ...
    public static unsafe partial class UnsafeMethods
    {
        ...
        /// <exception cref="NullReferenceException"><paramref name="source"/> was <see langword="null"/>.</exception>
        /// <exception cref="ArgumentException"><paramref name="count"/> and/or <paramref name="index"/> were negative or the combination of those two parameters exced the source array length.</exception>
        public static System.Byte[] GetBytes(this System.Byte[] source, System.Int32 index, System.Int32 count)
        {
            ...
            if (count < 0) { throw new ArgumentException("Count was negative." , nameof(count)); }
            if (index < 0) { throw new ArgumentException("Index was negative." , nameof(index)); }
            if (count - index > source.Length) { throw new ArgumentException("The source array does not have so many elements to copy!"); }
        ...
        public static System.Int32 PadAlignment(int align, int length)
        {
