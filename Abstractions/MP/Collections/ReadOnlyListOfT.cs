...
namespace MP.Collections
{
    ...
    public sealed class ReadOnlyList<T> : IList<T>, IGettableSettable<System.Int32 , T>, ITraversableCollection<T>, ICloneable, ISyncronized
    {
        ...
        public ReadOnlyList(IList<T> list)
        {
            ...
            } else if (list is ReadOnlyList<T> d) {
                this.list = d.list;
            } else {
                this.list = list;
            }
        ...
        public ReadOnlyList(IEnumerable<T> items)
        {
            list = items switch {
                ...
                ReadOnlyList<T> rdonly => rdonly.list,
                IList<T> listitems => listitems,
                _ => new ArrayBasedList<T>(items),
            };
        }
