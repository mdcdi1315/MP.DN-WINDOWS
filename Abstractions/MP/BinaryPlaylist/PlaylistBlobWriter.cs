...
namespace MP.BinaryPlaylist
{
    ...
    /// Apart from the Write method that can write directly to the newly created blob , <br />
    /// it does provide utility methods to write simple numeric types and strings easily.
    /// </summary>
    public class PlaylistBlobWriter : IDisposable
    {
        private BLOBHEADER header;
        private Microsoft.IO.InternalMemoryStream mems;
        /// <summary>
