...
namespace MP.PlaylistManagement
{
    ...
    /// Playlist instances are intermediary objects providing services for managing them, learning the tracks
    ...
    public abstract class Playlist : IDisposable
    {
        ...
        /// Also loaded on demand, but it is an internal aspect of the playlist and should be irrelevant to the audio tag cover image cache.
        /// </summary>
