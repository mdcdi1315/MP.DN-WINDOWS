...
namespace MP.PlaylistManagement
{
    ...
    public sealed class PlaylistMetadataValue
    {
        ...
        public static void WriteTo(PlaylistMetadataValue pmv , System.IO.Stream stream)
        {
        ...
        private unsafe static void WriteToInternal(PlaylistMetadataValue pmv, System.IO.Stream stream)
        {
        ...
        [return: NotNull]
        public static PlaylistMetadataValue ReadFrom(System.IO.Stream stream)
        {
            ArgumentNullException.ThrowIfNull(stream);
            if (!stream.CanRead) {
        ...
        private static PlaylistMetadataValue ReadFromInternal(System.IO.Stream stream)
        {
