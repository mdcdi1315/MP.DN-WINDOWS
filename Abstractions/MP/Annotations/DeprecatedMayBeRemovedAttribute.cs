...
namespace MP.Annotations
{
    ...
    public sealed class DeprecatedMayBeRemovedAttribute : Attribute
    {
        ...
        public DeprecatedMayBeRemovedAttribute(System.String removedwhen)
        {
            versionwhen = removedwhen;
        }

        /// <summary>
        /// Signifies the version when the linked API will be removed.
        /// </summary>
