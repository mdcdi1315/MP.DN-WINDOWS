...
namespace MP.TagReading
{
    ...
    public sealed class MP4AudioTagReader : ITagReader
    {
        ...
        public MP4AudioTagReader(IO.DataStream stream) : this()
        {
        ...
        private static Box ReadAtomFromStream(IO.DataStream stream)
        {
        ...
        /// <inheritdoc />
        public string Title => GetAtomAndReturnAsString("nam");
        ...
        /// <inheritdoc />
        public IO.DataStream Image => new IO.MemoryStream(GetAtomAndReturnBytes("covr"));

        /// <inheritdoc />
        [return: MaybeNull]
        [return: AlwaysReturnsTypeThroughBoxedObject(typeof(System.Byte[]))]
        public object GetProperty(string name) => GetAtomAndReturnBytes(name);
