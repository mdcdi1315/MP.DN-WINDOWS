...
namespace Microsoft.IO
{
    ...
    /// </summary>
    internal class InternalMemoryStream : Stream
    {
        ...
        public InternalMemoryStream(System.Int64 requiredcap , System.Boolean isexpandable)
        {
            if (requiredcap < 0) {
        ...
        public InternalMemoryStream(System.Byte[] buffer , System.Boolean isexpandable)
        {
        ...
        /// <param name="buffer">The buffer to initialize the memory stream from.</param>
        /// <exception cref="ArgumentNullException"><paramref name="buffer"/> was <see langword="null"/>.</exception>
        public InternalMemoryStream(System.Byte[] buffer) : this(buffer , true) { }
        ...
        /// <param name="requiredcap">The capacity to be pre-allocated.</param>
        /// <exception cref="ArgumentOutOfRangeException"><paramref name="requiredcap"/> was negative.</exception>
        public InternalMemoryStream(System.Int64 requiredcap) : this(requiredcap, true) { }
        ...
        /// <summary>
        /// Adjusts the memory space that the current <see cref="InternalMemoryStream"/> instance is occupying. <br />
        /// Can be overriden for custom implementations
        /// </summary>
        ...
        public System.Byte[] GetRawBuffer() => buffer;
