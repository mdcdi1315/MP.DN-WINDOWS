...
namespace MP.Graphics.Text.DWrite
{
    ...
    /// </summary>
    [COMInterfaceGenerator("cca920e4-52f0-492b-bfa8-29c72ee0a468")]
    public unsafe partial interface IDWriteFontCollectionLoader
    {
        /// <summary>
        ...
        HRESULT CreateEnumeratorFromKey(
            ...
            [IsPointerToCOMInterfaceType(typeof(IDWriteFontFileEnumerator))] void** fontFileEnumerator
        );
    }
}
