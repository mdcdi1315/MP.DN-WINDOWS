...
namespace MP.Graphics.Text.DWrite
{
    ...
    /// </summary>
    [COMInterfaceGenerator("739d886a-cef5-47dc-8769-1a8b41bebbb0")]
    public unsafe partial interface IDWriteFontFile
    {
        /// <summary>
        ...
        /// Standard HRESULT error code.
        /// </returns>
        HRESULT GetLoader([IsPointerToCOMInterfaceType(typeof(IDWriteFontFileLoader))] void** fontFileLoader);
