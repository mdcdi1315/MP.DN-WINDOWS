...
partial class Interop
{
    ...
    {
        [AssignsLastError]
        [DllImport(Libraries.Kernel32 , EntryPoint = "GetCurrentDirectoryW", ExactSpelling = true)]
        ...
        public static System.String GetCurrentDirectory() 
        {
            ...
            if (fs > 4 && new System.String(nativech , 0 ,4) == NativePathManipulations.ExtendedPathPrefix) { idx = 4; }
            return new System.String(nativech , idx , (fs - idx).ToInt32());
        }

        [AssignsLastError]
        [DllImport(Libraries.Kernel32, EntryPoint = "SetCurrentDirectoryW" , ExactSpelling = true)]
        ...
        {
            fixed (System.Char* buffer = NativePathManipulations.EnsureExtendedPrefix(path))
            {
        ...
        [AssignsLastError]
        [DllImport(Libraries.Kernel32 , EntryPoint = "IsNativeVhdBoot" , ExactSpelling = true)]
        ...
        [DllImport(Libraries.Kernel32, EntryPoint = "GetSystemTimeAsFileTime")]
        ...
        [AssignsLastError]
        [DllImport(Libraries.Kernel32 , EntryPoint = "GetSystemWindowsDirectoryW", ExactSpelling = true)]
        ...
        public static System.String GetSystemWindowsDirectory()
        {
            ...
            return GetAndTrimString(result.AsSpan());
        }

        [AssignsLastError]
        [DllImport(Libraries.Kernel32 , EntryPoint = "GetSystemDirectoryW" , ExactSpelling = true)]
        ...
        [AssignsLastError]
        [DllImport(Libraries.Kernel32 , EntryPoint = "GetComputerNameExW" , ExactSpelling = true)]
        ...
        public static System.String GetComputerNameEx(COMPUTER_NAME_FORMAT format)
        {
            ...
            System.UInt32 sizeinout = ret.Length.ToUInt32();
        ...
        [AssignsLastError]
        [DllImport(Libraries.Kernel32 , EntryPoint = "GetFirmwareType" , ExactSpelling = true)]
        ...
        [AssignsLastError]
        [DllImport(Libraries.Kernel32 , EntryPoint = "GetSystemPowerStatus" , ExactSpelling = true)]
        ...
        [DllImport(Libraries.Kernel32, EntryPoint = "GetActiveProcessorCount", ExactSpelling = true)]
        ...
        [AssignsLastError]
        [DllImport(Libraries.Kernel32 , EntryPoint = "ExpandEnvironmentStringsW" , ExactSpelling = true)]
        ...
        [AssignsLastError]
        [DllImport(Libraries.Kernel32 , EntryPoint = "GetEnvironmentVariableW")]
        ...
        public static System.String GetEnvironmentVariable(System.String name)
        {
            ...
            if (fs == 0) {
                System.UInt32 err = GetLastError();
        ...
        [AssignsLastError]
        [DllImport(Libraries.Kernel32 , EntryPoint = "SetEnvironmentVariableW" , ExactSpelling = true)]
        ...
        [AssignsLastError]
        [DllImport(Libraries.Kernel32 , EntryPoint = "FileTimeToSystemTime" , ExactSpelling = true)]
        ...
        [AssignsLastError]
        [DllImport(Libraries.Kernel32 , EntryPoint = "SystemTimeToFileTime" , ExactSpelling = true)]
        ...
        [AssignsLastError]
        [DllImport(Libraries.Kernel32 , EntryPoint = "FreeEnvironmentStringsW" , ExactSpelling = true)]
