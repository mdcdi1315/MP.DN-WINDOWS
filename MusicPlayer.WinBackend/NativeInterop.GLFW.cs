...
using unsafe GLFWerrorfun = delegate* unmanaged[Cdecl]<Interop.GLFW.Errors, byte*, void>;
using unsafe GLFWwindowclosefun = delegate* unmanaged[Cdecl]<Interop.GLFW.GLFW_WINDOW, void>;
using unsafe GLFWwindowrefreshfun = delegate* unmanaged[Cdecl]<Interop.GLFW.GLFW_WINDOW, void>;
using unsafe GLFWwindowposfun = delegate* unmanaged[Cdecl]<Interop.GLFW.GLFW_WINDOW, int, int, void>;
using unsafe GLFWwindowsizefun = delegate* unmanaged[Cdecl]<Interop.GLFW.GLFW_WINDOW, int, int, void>;
using unsafe GLFWscrollfun = delegate* unmanaged[Cdecl]<Interop.GLFW.GLFW_WINDOW, double, double, void>;
using unsafe GLFWjoystickfun = delegate* unmanaged[Cdecl]<int, Interop.GLFW.GLFW_CONNECTION_EVENT, void>;
using unsafe GLFWframebuffersizefun = delegate* unmanaged[Cdecl]<Interop.GLFW.GLFW_WINDOW, int, int, void>;
using unsafe GLFWcursorposfun = delegate* unmanaged[Cdecl]<Interop.GLFW.GLFW_WINDOW, double, double, void>;
using unsafe GLFWwindowcontentscalefun = delegate* unmanaged[Cdecl]<Interop.GLFW.GLFW_WINDOW, float, float, void>;
using unsafe GLFWwindowiconifyfun = delegate* unmanaged[Cdecl]<Interop.GLFW.GLFW_WINDOW, Interop.GLFW.GLFW_BOOLEAN, void>;
using unsafe GLFWmonitorfun = delegate* unmanaged[Cdecl]<Interop.GLFW.GLFW_MONITOR, Interop.GLFW.GLFW_MONITOR_CALLBACK_EVENT_TYPE, void>;
using unsafe GLFWkeyfun = delegate* unmanaged[Cdecl]<Interop.GLFW.GLFW_WINDOW, Interop.GLFW.GLFW_KEY, int, Interop.GLFW.GLFW_KEY_PRESS_INFO, Interop.GLFW.GLFW_MODIFIER_KEY_FLAGS, void>;
using unsafe GLFWmousebuttonfun = delegate* unmanaged[Cdecl]<Interop.GLFW.GLFW_WINDOW, Interop.GLFW.GLFW_MOUSE_BUTTON, Interop.GLFW.GLFW_KEY_PRESS_INFO, Interop.GLFW.GLFW_MODIFIER_KEY_FLAGS, void>;
...
partial class Interop
{
    ...
    public unsafe static class GLFW
    {
        ...
        /// <summary>
        /// This is not an actual exported enumeration type from the native library, it is just to group all the possible OpenGL profiles.
        /// </summary>
        public enum GLFW_OPENGL_PROFILE_TYPE : System.Int32
        {
        ...
        /// <summary>
        /// This is not an actual exported enumeration type from the native library, it is just to group all the possible graphics API's.
        /// </summary>
        public enum GLFW_API : System.Int32
        {
            GLFW_NO_API = 0,
        ...
        public struct GLFW_ALLOCATOR
        {
            ...
            /// </summary>
            public delegate* unmanaged[Cdecl]<UIntPtr, void*, void*> Allocate;
            ...
            /// </summary>
            public delegate* unmanaged[Cdecl]<void*, UIntPtr, void*, void*> Reallocate;
        ...
        private static MP.NativeInterop.StringHandle ToUTF8String(System.String value) => MP.NativeInterop.INativeMemoryManagerExtensions.CreateUTF8StringHandle(MP.SystemInfo.GetDefaultMemoryManager(), value);
        ...
        [DllImport(Libraries.GLFW , CallingConvention = CallingConvention.Cdecl,  ExactSpelling = true)]
        ...
        [DllImport(Libraries.GLFW, EntryPoint = "glfwGetVersion", CallingConvention = CallingConvention.Cdecl,  ExactSpelling = true)]
        ...
        [DllImport(Libraries.GLFW , EntryPoint = "glfwGetVersionString", CallingConvention = CallingConvention.Cdecl,  ExactSpelling = true)]
        ...
        [DllImport(Libraries.GLFW, EntryPoint = "glfwGetError", CallingConvention = CallingConvention.Cdecl,  ExactSpelling = true)]
        ...
        [DllImport(Libraries.GLFW, EntryPoint = "glfwGetMonitors", CallingConvention = CallingConvention.Cdecl,  ExactSpelling = true)]
        private static extern GLFW_MONITOR* glfwGetMonitors_Native(int* count);

        public static Span<GLFW_MONITOR> glfwGetMonitors()
        {
            int count;
            GLFW_MONITOR* pmonitors = glfwGetMonitors_Native(&count);
            return new Span<GLFW_MONITOR>(pmonitors, count);
        }

        [DllImport(Libraries.GLFW, EntryPoint = "glfwGetMonitorWorkarea", CallingConvention = CallingConvention.Cdecl,  ExactSpelling = true)]
        ...
        [DllImport(Libraries.GLFW, EntryPoint = "glfwGetMonitorPhysicalSize", CallingConvention = CallingConvention.Cdecl,  ExactSpelling = true)]
        ...
        [DllImport(Libraries.GLFW, EntryPoint = "glfwGetMonitorContentScale", CallingConvention = CallingConvention.Cdecl,  ExactSpelling = true)]
        ...
        [DllImport(Libraries.GLFW, EntryPoint = "glfwGetMonitorName", CallingConvention = CallingConvention.Cdecl,  ExactSpelling = true)]
        ...
        [DllImport(Libraries.GLFW, CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
        public static extern GLFWmonitorfun glfwSetMonitorCallback(GLFWmonitorfun newdelegate);

        [DllImport(Libraries.GLFW, EntryPoint = "glfwGetVideoModes", CallingConvention = CallingConvention.Cdecl,  ExactSpelling = true)]
        private static extern GLFW_VIDEO_MODE* glfwGetVideoModes_Native(GLFW_MONITOR monitor, int* count);

        public static Span<GLFW_VIDEO_MODE> glfwGetVideoModes(GLFW_MONITOR monitor)
        {
            int count;
            GLFW_VIDEO_MODE* gvm = glfwGetVideoModes_Native(monitor, &count);
            return new Span<GLFW_VIDEO_MODE>(gvm, count);
        }

        [DllImport(Libraries.GLFW, EntryPoint = "glfwGetVideoMode", CallingConvention = CallingConvention.Cdecl,  ExactSpelling = true)]
        ...
        [DllImport(Libraries.GLFW, EntryPoint = "glfwGetGammaRamp", CallingConvention = CallingConvention.Cdecl,  ExactSpelling = true)]
        ...
        [DllImport(Libraries.GLFW, EntryPoint = "glfwSetGammaRamp", CallingConvention = CallingConvention.Cdecl,  ExactSpelling = true)]
        ...
        [DllImport(Libraries.GLFW, CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
        public static extern GLFWwindowposfun glfwSetWindowPosCallback(GLFW_WINDOW window, GLFWwindowposfun replacewith);

        [DllImport(Libraries.GLFW, CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
        public static extern GLFWwindowsizefun glfwSetWindowSizeCallback(GLFW_WINDOW window, GLFWwindowsizefun replacewith);

        [DllImport(Libraries.GLFW, CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
        public static extern GLFWwindowclosefun glfwSetWindowCloseCallback(GLFW_WINDOW window, GLFWwindowclosefun replacewith);

        [DllImport(Libraries.GLFW, CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
        public static extern GLFWwindowiconifyfun glfwSetWindowIconifyCallback(GLFW_WINDOW window, GLFWwindowiconifyfun replacewith);

        [DllImport(Libraries.GLFW, CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
        public static extern GLFWframebuffersizefun glfwSetFramebufferSizeCallback(GLFW_WINDOW window, GLFWframebuffersizefun replacewith);

        [DllImport(Libraries.GLFW, CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
        public static extern GLFWwindowcontentscalefun glfwSetWindowContentScaleCallback(GLFW_WINDOW window, GLFWwindowcontentscalefun replacewith);
        
        [DllImport(Libraries.GLFW, CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
        public static extern GLFWwindowrefreshfun glfwSetWindowRefreshCallback(GLFW_WINDOW window, GLFWwindowrefreshfun replacewith);
        ...
        [DllImport(Libraries.GLFW, EntryPoint = "glfwCreateWindow", CallingConvention = CallingConvention.Cdecl,  ExactSpelling = true)]
        ...
        [DllImport(Libraries.GLFW, EntryPoint = "glfwGetWindowTitle", CallingConvention = CallingConvention.Cdecl,  ExactSpelling = true)]
        ...
        [DllImport(Libraries.GLFW, EntryPoint = "glfwSetWindowTitle", CallingConvention = CallingConvention.Cdecl,  ExactSpelling = true)]
        ...
        [DllImport(Libraries.GLFW, EntryPoint = "glfwSetWindowIcon", CallingConvention = CallingConvention.Cdecl,  ExactSpelling = true)]
        ...
        [DllImport(Libraries.GLFW, EntryPoint = "glfwGetWindowPos", CallingConvention = CallingConvention.Cdecl,  ExactSpelling = true)]
        ...
        [DllImport(Libraries.GLFW, EntryPoint = "glfwGetWindowSize", CallingConvention = CallingConvention.Cdecl,  ExactSpelling = true)]
        ...
        [DllImport(Libraries.GLFW, EntryPoint = "glfwGetFramebufferSize", CallingConvention = CallingConvention.Cdecl,  ExactSpelling = true)]
        ...
        [DllImport(Libraries.GLFW, EntryPoint = "glfwGetWindowFrameSize", CallingConvention = CallingConvention.Cdecl,  ExactSpelling = true)]
        ...
        [DllImport(Libraries.GLFW, EntryPoint = "glfwGetWindowContentScale", CallingConvention = CallingConvention.Cdecl,  ExactSpelling = true)]
        ...
        [DllImport(Libraries.GLFW, CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
        public static extern void glfwSetWindowUserPointer(GLFW_WINDOW window, void* pointer);

        [DllImport(Libraries.GLFW, CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
        public static extern void* glfwGetWindowUserPointer(GLFW_WINDOW window);
        ...
        [DllImport(Libraries.GLFW, EntryPoint = "glfwGetCursorPos", CallingConvention = CallingConvention.Cdecl,  ExactSpelling = true)]
        ...
        [DllImport(Libraries.GLFW, EntryPoint = "glfwCreateCursor", CallingConvention = CallingConvention.Cdecl,  ExactSpelling = true)]
        ...
        [DllImport(Libraries.GLFW, CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
        public static extern GLFWcursorposfun glfwSetCursorPosCallback(GLFW_WINDOW window, GLFWcursorposfun replacewith);

        [DllImport(Libraries.GLFW, CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
        public static extern GLFWkeyfun glfwSetKeyCallback(GLFW_WINDOW window, GLFWkeyfun replacewith);

        [DllImport(Libraries.GLFW, CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
        public static extern GLFWmousebuttonfun glfwSetMouseButtonCallback(GLFW_WINDOW window, GLFWmousebuttonfun replacewith);

        [DllImport(Libraries.GLFW, CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
        public static extern GLFWscrollfun glfwSetScrollCallback(GLFW_WINDOW window, GLFWscrollfun replacewith);

        [DllImport(Libraries.GLFW, EntryPoint = "glfwSetJoystickCallback", CallingConvention = CallingConvention.Cdecl,  ExactSpelling = true)]
        public static extern GLFWjoystickfun glfwSetJoystickCallback(GLFWjoystickfun replacewith);

        [DllImport(Libraries.GLFW, EntryPoint = "glfwGetJoystickAxes", CallingConvention = CallingConvention.Cdecl,  ExactSpelling = true)]
        ...
        [DllImport(Libraries.GLFW, EntryPoint = "glfwGetJoystickButtons", CallingConvention = CallingConvention.Cdecl,  ExactSpelling = true)]
        ...
        [DllImport(Libraries.GLFW, EntryPoint = "glfwGetJoystickName", CallingConvention = CallingConvention.Cdecl,  ExactSpelling = true)]
        ...
        [DllImport(Libraries.GLFW, EntryPoint = "glfwGetJoystickGUID", CallingConvention = CallingConvention.Cdecl,  ExactSpelling = true)]
        ...
        [DllImport(Libraries.GLFW, EntryPoint = "glfwUpdateGamepadMappings", CallingConvention = CallingConvention.Cdecl,  ExactSpelling = true)]
        ...
        [DllImport(Libraries.GLFW, EntryPoint = "glfwGetGamepadName", CallingConvention = CallingConvention.Cdecl,  ExactSpelling = true)]
        ...
        [DllImport(Libraries.GLFW, EntryPoint = "glfwGetGamepadState", CallingConvention = CallingConvention.Cdecl,  ExactSpelling = true)]
        ...
        [DllImport(Libraries.GLFW, EntryPoint = "glfwSetClipboardString", CallingConvention = CallingConvention.Cdecl,  ExactSpelling = true)]
        ...
        {
            var mem = ToUTF8String(clipboardstring);
            try {
        ...
        [DllImport(Libraries.GLFW, EntryPoint = "glfwGetClipboardString", CallingConvention = CallingConvention.Cdecl,  ExactSpelling = true)]
        ...
        [DllImport(Libraries.GLFW, CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
        public static extern void glfwMakeContextCurrent(GLFW_WINDOW window);

        [DllImport(Libraries.GLFW, EntryPoint = "glfwGetProcAddress", CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
        private static extern void* glfwGetProcAddress_Native(byte* proc_name);

        [DllImport(Libraries.GLFW, EntryPoint = "glfwExtensionSupported", CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
        private static extern GLFW_BOOLEAN glfwExtensionSupported_Native(byte* ext_name);

        public static GLFW_BOOLEAN glfwExtensionSupported(ReadOnlySpan<byte> ext_name)
        {
            fixed (System.Byte* p = ext_name) {
                return glfwExtensionSupported_Native(p);
            }
        }

        public static void* glfwGetProcAddress(ReadOnlySpan<byte> proc_name)
        {
            fixed (System.Byte* p = proc_name) {
                return glfwGetProcAddress_Native(p);
            }
        }

        public static void* glfwGetProcAddress(System.String str)
        {
            var sh = ToUTF8String(str);
            try {
                return glfwGetProcAddress_Native(sh);
            } finally {
                sh.Dispose();
            }
        }
