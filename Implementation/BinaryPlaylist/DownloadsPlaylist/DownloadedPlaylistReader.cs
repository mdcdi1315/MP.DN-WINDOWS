...
{
    public sealed class DownloadsPlaylistReader : IDisposable
    {
        private BinaryPlaylistReader reader;
        private Dictionary<BlobTypes, PlaylistBlobReader> readerspooled;

        public DownloadsPlaylistReader(System.IO.Stream stream)
        {
        ...
        public PlaylistURLBlobReader URLBlobReader => GetReader<PlaylistURLBlobReader>(BlobTypes.MAXEMBEDDEDBLOBVAL + 1);
