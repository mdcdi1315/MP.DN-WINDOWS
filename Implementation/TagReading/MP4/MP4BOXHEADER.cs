...
namespace MP.TagReading.MP4
{
    ...
    internal unsafe struct MP4BOXHEADER
    {
        ...
        public static (MP4BOXHEADER , System.Int32 factualsize) ReadHeader(System.IO.Stream stream)
        {
    ...
    internal unsafe struct MP4METABOXCOREHEADER
    {
        ...
        public AppleDataTagFlags Flags
        {
            get
            {
                ...
                dt[0] = 0;
                Unsafe.CopyBlockUnaligned(ref dt[1], in flags[0], 3);
                if (BitConverter.IsLittleEndian) { dt.Reverse(); }
            ...
            set
            {
                ...
                if (BitConverter.IsLittleEndian) { dt.Reverse(); }
                Unsafe.CopyBlockUnaligned(ref flags[0], in dt[1], 3);
            }
        }
